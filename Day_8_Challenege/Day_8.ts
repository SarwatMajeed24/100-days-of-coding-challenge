...
let colour: string = "red";                                // single = assign the value
...
// Inequality Test
console.log("Equality test with string: ", ("Pakistani" as string) !== "American");
...
console.log("Numerical Tests Involving Inequality Test:", (20 as number) != 15);
